export const cvData = {
  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        "Worked on PlayStation's Dreams games creation system.",
        "Documented software malfunctions, using a bug tracking system, and reported defects to software developers - several blockers (s1) and countless critical bugs (s2).",
        "Participated in daily calls with international clients - Sony, Media Molecule et al.",
        "Held responsible for monitoring bug resolution efforts and track successes."
      ]
    },
    {
      title: "Digital Specialist",
      ...
      bullets: [
        "Supported digital operations through content production and asset management.",
  ...
  personalAchievements: [
    "Awarded with \"Studienstiftung Des Deutsches Volkes\" scholarship for the higher education of young people showing exceptional promise for academic accomplishment, who stand out by virtue of their personality and are willing to render service to society as a whole.",
    "Recognized by the Esquire Magazine for creating pioneer creative works. Published interview in August 2020 issue about the journey and accomplishments during the artistic research in Singapore.",
    "Collaborated with Ministry of Education in Singapore to create a 45-minute project exposing the myriad facets of movement that stand at the core of the local contemporary dance scene.",
    "Titled as a World Champion in Modern Dance by International Dance Organization - Serbia 2011"
  ],

  professionalAchievements: [
    {
      title: "Prevented Global App Crisis:",
      description: "Took initiative to test the system before iOS 18 official release, identifying major integration flaws with media servers. My actions resolved the issue before launch, preventing a worldwide failure and saving the company from serious financial and reputational harm."
    },
    {
      title: "Record Engagement for Client Projects:",
